...
public class ErrorDialog {
    ...
    // 确定
    public TextView dialog_retry;
    // 取消
    public TextView dialog_cancle;

    private Activity currentActivity;

    public ErrorDialog(Context context, int title, int message, int possitiveString) {
        currentActivity = (Activity) context;
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.dialog_neterror, null);
        ...
        dialog_retry = (TextView) view.findViewById(R.id.dialog_retry);
        dialog_retry.setText(possitiveString);
