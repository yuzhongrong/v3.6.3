...
public class ListViewFrame extends ListView  implements OnScrollListener {
	...
	public ListViewFrame(Context context, AttributeSet attrs) {
		super(context, attrs);
		initWithContext(context);
	}

	public ListViewFrame(Context context, AttributeSet attrs, int defStyle) {
...
//		setSelection(mTotalItemCount - 1); // scroll to bottom
	...
	public void setXListViewListener(FragmentActivity fragmentActivity) {
		mListViewListener = (IXListViewListener) fragmentActivity;
	}
