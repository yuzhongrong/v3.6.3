...
//		 timeTextView = (TextView) refreshView.findViewById(R.id.refresh_time);
	...
	private void fling() {
		...
		MyLog.i(TAG, "fling()" + lp.topMargin);
...
//		timeTextView.setVisibility(View.VISIBLE);
		...
		if(lp.topMargin >  0){
			...
			refreshIndicatorView.setImageResource(R.drawable.xlistview_arrow2);
		}else{
			downTextView.setText(R.string.refresh_down_text);
			refreshIndicatorView.setImageResource(R.drawable.xlistview_arrow);//下
		}
