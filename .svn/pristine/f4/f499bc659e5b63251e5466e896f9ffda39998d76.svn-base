...
public class TabLayout extends HorizontalScrollView implements OnClickListener {
    ...
    private int mSelectedColor = Color.parseColor("#0c71e3");
    // Default width.
    ...
    public void addTab(int index, String title) {
        ...
        tab.setTypeface(Typeface.SANS_SERIF);
    ...
    public void initStrip() {
        ...
        mLastSelectedTab.setTextSize(selectTextSize);
        post(new Runnable() {
            @Override
            public void run() {
                int w = mTabWidth;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == MeasureSpec.AT_MOST) {// wrap_content
            ...
            widthMeasureSpec = MeasureSpec.makeMeasureSpec(specWidth, MeasureSpec.EXACTLY);// match_parent
        }
        int heightMode = MeasureSpec.getMode(heightMeasureSpec);
        if (heightMode == MeasureSpec.AT_MOST) {
            int minSize = getDipSize(50);// Minimum size 50dp
            heightMeasureSpec = MeasureSpec.makeMeasureSpec(minSize, MeasureSpec.EXACTLY);
        }
    ...
    public void onClick(View view) {
        ...
        mLastSelectedTab.setTextSize(textSize);
        TextView currentTab = (TextView) view;
        currentTab.setTextColor(mSelectedColor);
        currentTab.setTextSize(selectTextSize);
