...
public class New_PreferencesUtils{
     ...
     * @param value
     */
    public static void putBooleanToSPMap(String key, boolean value) {
        preferences = JinrApp.getInstance().getSharedPreferences(Keys.USERINFO, Context.MODE_PRIVATE);
    ...
    public static void putReadAction(Context mContext, String key, HashSet<String> hashSet) {
        String uid = New_PreferencesUtils.getValueFromSPMap(mContext, New_PreferencesUtils.Keys.UID);
