...
public class CannotReceiveTextDialog {
    ...
    public CannotReceiveTextDialog(Context context) {

        currentActivity = (Activity) context;
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.dialog_no_code, null);
        mDialog = new Dialog(context, R.style.NoMassageDialog);
        ...
        dialog_message.setText(currentActivity.getResources().getString(R.string.no_message_tip) +
                PreferencesUtils.getCValueFromSPMap(currentActivity, PreferencesUtils.Keys.KEFU_PHONE));
