...
public class NewCustomDialogWithTitle {
    ...
    public NewCustomDialogWithTitle(Context context, String title, String message) {
        currentActivity = (Activity) context;
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.dialog_custom_new_with_title, null);
